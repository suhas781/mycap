...
import { getBoes, getTeamLeads, getAllUsers, setUserRole, setReportsTo, setEmploymentStatus, removeAllExceptMe, deleteUserById } from '../controllers/userController.js';
...
router.delete('/:id', authRequired, hrOnly, deleteUserById);
